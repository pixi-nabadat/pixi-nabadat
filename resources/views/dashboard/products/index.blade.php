                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="featured" id="validationCustom01">
                                        <option disabled selected value="" selected>Choose...</option>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label" for="validationCustom02">@lang('lang.product_name')</label>
                                    <input class="form-control" name="name" id="validationCustom02" type="text" value="t">
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label" for="validationCustom02">@lang('lang.stock_less_than')</label>
                                    <input class="form-control" name="stock_less_than" id="validationCustom02" type="number" value="0">
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                            </div>
                            <div class="row">
