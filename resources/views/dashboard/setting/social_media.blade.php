    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
            ...
            <form class="needs-validation" novalidate="" method="post" enctype="multipart/form-data"
                action="{{ route('settings.store.social_media') }}">
                @csrf
                <div class="row ">
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="card  col-md-12">
                                <div class="card-header py-4">
                                    <h6 class="card-titel">{{config('setting_fields.social_media.title') }}</h6>
                                </div>
                                <div class="card-body row">

                                    @foreach(config('setting_fields.social_media.elements') as $field)
                                        {{-- name_ar  --}}
                                        <div class="col-md-12 d-flex my-3">
                                            ...
                                            <input name="{{ $field['name'] }}" class="{{ $field['class'] }}"
                                                ...
                                                required=""
                                                value="{{ isset(config('global.'.$field['name'])) }}">
                                            @error($field['name'])
