<a href="{{ route('show.governorate',['id' => $location->id]) }}" >
    <i class="fa fa-eye"></i>
</a>

<a href="{{ route('edit.governorate',['id' => $location->id]) }}" >
    <i class="fa fa-pencil-square-o"></i>
</a>


<form class="delete_form" id="myformarticle{{$location->id}}"  action="{{ route('delete.governorate',['id' => $location->id])}}" method="post">
