<a href="{{ route('show.city',['id' => $location->id]) }}" >
    <i class="fa fa-eye"></i>
</a>

<a href="{{ route('edit.city',['id' => $location->id]) }}" >
    <i class="fa fa-pencil-square-o"></i>
</a>


<form class="delete_form" id="myformarticle{{$location->id}}"  action="{{ route('delete.city',['id' => $location->id])}}" method="post">
