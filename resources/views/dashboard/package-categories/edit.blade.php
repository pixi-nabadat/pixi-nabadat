...
<li class="breadcrumb-item active"><a href="{{route('package-categories.index')}}">{{ trans('lang.package_categories') }}</a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" enctype="multipart/form-data"  action="{{ route('package-categories.update',$packageCategory) }}" method="post" >
                            @csrf
                            @method('put')

                                <div class="col-md-12">
                                    <label class="form-label" for="name_ar">{{ trans('lang.name_ar') }}</label>
                                    <input name="name[ar]"   value={{ $packageCategory->getTranslation('name', 'ar') }} class="form-control @error('name.ar') is-invalid @enderror"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input name="name[en]" value={{ $packageCategory->getTranslation('name', 'en') }} class="form-control @error('name.en') is-invalid @enderror"
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    @if($packageCategory->attachments->count())
                                        @foreach($packageCategory->attachments as $attachment)
                                    ...
                                    <div class="media-body  icon-state">
                                        <label class="switch">
                                            <input type="checkbox" name="is_active"
                                                {{ $packageCategory->is_active == 1 ? 'checked' : '' }}><span
