...
<div class="sidebar-wrapper">
	<div>
		<div class="logo-wrapper text-center">
			 <a href="{{route('home')}}"><img class="img-fluid for-light" style="width: 110px" src="{{asset('images/icons/2.png')}}" alt=""><img class="img-fluid for-dark" src="{{asset('images/icons/2.png')}}" alt=""></a>
			<div class="back-btn"><i class="fa fa-angle-left"></i></div>
			<div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
		</div>
		<div class="logo-icon-wrapper"><a href="{{route('home')}}"><img class="img-fluid" src="{{asset('assets/images/icons/2.png')}}" alt=""></a></div>
		<nav class="sidebar-main">
			<div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					<li class="back-btn">
						<a href="{{route('home')}}"><img class="img-fluid" src="{{asset('assets/images/icons/2.png')}}" alt=""></a>
