...
//    check availability stocks of products
        ...
        $payment_method = $request->payment_method == Order::PAYMENTCREDIT ? Order::PAYMENTCREDIT : Order::PAYMENTCASH;
        $deleted_at = $payment_method == PaymentMethod::CREDIT ? true : null;
