...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_packages', function (Blueprint $table) {
            ...
            $table->enum('status',[\App\Enum\UserPackageStatusEnum::PENDING,\App\Enum\UserPackageStatusEnum::READYFORUSE,\App\Enum\UserPackageStatusEnum::ONGOING,\App\Enum\UserPackageStatusEnum::COMPLETED,\App\Enum\UserPackageStatusEnum::EXPIRED]);
